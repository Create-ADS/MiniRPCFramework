...
public class UserInboundHandlerAdapter extends ChannelInboundHandlerAdapter {
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        ServiceRegisterManage manage = ServiceRegisterFactory.referService("online.pigeonshouse.minirpc.service.impl", ctx.channel());;
        put.put("serviceRegisterManage", manage);
